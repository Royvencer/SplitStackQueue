...
int main()
{
	...
	{
		pQueue.insert(i, rand()); // Insert a key along with the value
	}
	//pull them back out..
	...
	pqs.insert("whale", 6); // Example priority: 3
	pqs.insert("snake", 4); // Example priority: 1
	pqs.insert("buffalo", 1); // Example priority: 4
	pqs.insert("elmo", 2); // Example priority: 2
	pqs.insert("fire", 3); // Example priority: 5
	pqs.insert("waffle", 5); // Example priority: 6
